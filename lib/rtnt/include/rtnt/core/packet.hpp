...
inline std::string_view to_string(Error error)
{
    switch (error) {
        case Error::kNone:
            return "Success";
        case Error::kDataTooSmall:
            return "Data is too small to contain a RTNT header.";
        case Error::kProtocolMismatch:
            return "Protocol ID mismatch.";
        case Error::kPayloadSizeMismatch:
            return "Corrupted packet: Payload size does not match header.";
        default:
